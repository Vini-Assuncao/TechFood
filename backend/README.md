...
API Backend construída em Node.js com padrão de arquitetura MVC (Model-View-Controller) e banco de dados MySQL para o sistema de gestão da "TechFood" (Cardápios, Pedidos, Produtos).
...
3. Execute o script do arquivo **`database.sql`** que está na raiz do projeto. Ele criará o banco de dados `techfood` juntamente com todas as tabelas necessárias e alguns dados iniciais.
